...
**NLP**
- 현재 퀀텀AI에서 텍스트 데이터 처리 및 분석, FAQ Engine, Semantic Paragraph Chunking, 고객 의도 분류 모델 등 비즈니스에 활용할 수 있는 다양한 과제를 연구하고 있습니다.
...
| 기간 | 소속 | 업무 | 직책 | 비고 |
| :------: | :------: | :------: | :------: | :------: |
| 2022.03 ~ 2022.06| 콴텍 AI 융합팀 | 데이터 수집 및 분석, AI 알고리즘 설계 및 개발(모델링) | 인턴 | 수료 |
| 2022.07 ~ 2023.03| 콴텍 AI 융합팀 | 데이터 수집 및 분석, AI 알고리즘 설계 및 개발(모델링) | 매니저 | 퇴사 |
| 2024.01 ~ | 퀀텀 AI R&D | 음성, 자연어 관련 AI 솔루션 개발 / LLM 리서치 및 개발 | 연구원 | 재직 |
| 2024.05 ~ | 퀀텀 AI R&D | 롯데손해보험 FDS 데이터 분석 및 모델 개발 | 연구원 | 외주 |
